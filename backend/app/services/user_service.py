...
async def activate_user(
    ...
    notifications = await notification_service.notify_users(
        ...
        message="Your TracePilot account has been activated by an administrator.",
        actor_id=actor.id,
        entity_type="USER",
        entity_id=user.id,
        entity_key=user.email,
...
async def deactivate_user(
    ...
    notifications = await notification_service.notify_users(
        ...
        message="Your TracePilot account has been deactivated by an administrator.",
        actor_id=actor.id,
        entity_type="USER",
        entity_id=user.id,
        entity_key=user.email,
...
async def change_user_role(
    ...
    notifications = await notification_service.notify_users(
        ...
        message=(
            f"Your TracePilot role has been changed from "
